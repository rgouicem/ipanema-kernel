...
enum enqueue_task_reason_type {
	...
	EN_Q_NEW,
	EN_Q_WAKEUP,
	EN_Q_WAKEUP_MIGRATION_SMT,
	EN_Q_WAKEUP_MIGRATION_CACHE, /* Not SMT */
	EN_Q_WAKEUP_MIGRATION_NUMA,  /* Not (SMT or CACHE) */
	EN_Q_WAKEUP_MIGRATION,       /* Not (SMT or CACHE or NUMA). For example: on a 2 hops remote numa node */
	EN_Q_LOAD_BALANCE_MIGRATION_SMT,
	EN_Q_LOAD_BALANCE_MIGRATION_CACHE,
	EN_Q_LOAD_BALANCE_MIGRATION_NUMA,
